...
const UKULELE_CHORD_FINGERINGS: { [key: string]: (ChordNote | null)[] } = {
    'C Major': [{string:'G', fret:0, note:'G'}, {string:'C', fret:0, note:'C'}, {string:'E', fret:0, note:'E'}, {string:'A', fret:3, note:'C'}],
    'G Major': [{string:'G', fret:0, note:'G'}, {string:'C', fret:2, note:'D'}, {string:'E', fret:3, note:'G'}, {string:'A', fret:2, note:'B'}],
    'D Major': [{string:'G', fret:2, note:'A'}, {string:'C', fret:2, note:'D'}, {string:'E', fret:2, note:'F#'}, {string:'A', fret:0, note:'A'}],
    'A Major': [{string:'G', fret:2, note:'A'}, {string:'C', fret:1, note:'C#'}, {string:'E', fret:0, note:'E'}, {string:'A', fret:0, note:'A'}],
    'E Major': [{string:'G', fret:4, note:'B'}, {string:'C', fret:4, note:'E'}, {string:'E', fret:4, note:'G#'}, {string:'A', fret:2, note:'B'}],
    'F Major': [{string:'G', fret:2, note:'A'}, {string:'C', fret:0, note:'C'}, {string:'E', fret:1, note:'F'}, {string:'A', fret:0, note:'A'}],
    'A Minor': [{string:'G', fret:2, note:'A'}, {string:'C', fret:0, note:'C'}, {string:'E', fret:0, note:'E'}, {string:'A', fret:0, note:'A'}],
    'E Minor': [{string:'G', fret:0, note:'G'}, {string:'C', fret:4, note:'E'}, {string:'E', fret:3, note:'G'}, {string:'A', fret:2, note:'B'}],
    'D Minor': [{string:'G', fret:2, note:'A'}, {string:'C', fret:2, note:'D'}, {string:'E', fret:1, note:'F'}, {string:'A', fret:0, note:'A'}],
    'G7': [{string:'G', fret:0, note:'G'}, {string:'C', fret:2, note:'D'}, {string:'E', fret:1, note:'F'}, {string:'A', fret:2, note:'B'}],
    'C7': [{string:'G', fret:0, note:'G'}, {string:'C', fret:0, note:'C'}, {string:'E', fret:0, note:'E'}, {string:'A', fret:1, note:'A#'}],
    'E7': [{string:'G', fret:1, note:'G#'}, {string:'C', fret:2, note:'D'}, {string:'E', fret:0, note:'E'}, {string:'A', fret:2, note:'B'}],
    'Am7': [{string:'G', fret:0, note:'G'}, {string:'C', fret:0, note:'C'}, {string:'E', fret:0, note:'E'}, {string:'A', fret:0, note:'A'}],
    'Cmaj7': [{string:'G', fret:0, note:'G'}, {string:'C', fret:0, note:'C'}, {string:'E', fret:0, note:'E'}, {string:'A', fret:2, note:'B'}],
    'Dm7': [{string:'G', fret:2, note:'A'}, {string:'C', fret:2, note:'D'}, {string:'E', fret:1, note:'F'}, {string:'A', fret:3, note:'C'}],
};
