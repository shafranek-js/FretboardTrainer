...
export const dom = {
  ...
  midiConnectionStatus: document.getElementById('midiConnectionStatus') as HTMLElement,
  ...
  statsLastSessionInput: document.getElementById('statsLastSessionInput') as HTMLElement,
