...
export const SEMITONE_TO_NOTE = Object.fromEntries(Object.entries(NOTE_TO_SEMITONE).map(([k, v]) => [v, k]));
...
export const CHORDS: { [key: string]: string[] } = {
    ...
    'A Major': ['A', 'C#', 'E'], 'E Major': ['E', 'G#', 'B'], 'F Major': ['F', 'A', 'C'],
    // Minor
    'A Minor': ['A', 'C', 'E'], 'E Minor': ['E', 'G', 'B'], 'D Minor': ['D', 'F', 'A'],
    'B Minor': ['B', 'D', 'F#'],
    // Dominant 7th
    'C7': ['C', 'E', 'G', 'A#'], 'G7': ['G', 'B', 'D', 'F'], 'D7': ['D', 'F#', 'A', 'C'],
    'A7': ['A', 'C#', 'E', 'G'], 'E7': ['E', 'G#', 'B', 'D'], 'B7': ['B', 'D#', 'F#', 'A'],
    // Other 7ths
